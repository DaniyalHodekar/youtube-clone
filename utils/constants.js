export const API_KEY = "AIzaSyCnctCW7I1TVGF7H1H2WsiqmBuGV6H03kk";
export const YOUTUBE_API = `https://youtube.googleapis.com/youtube/v3/videos?part=snippet%2CcontentDetails%2Cstatistics&chart=mostPopular&regionCode=US&key=${API_KEY}&maxResults=20`;
...
export const VIDEO_INFO_API2 = `%2Cc0KYU2j0TM4%2CeIho2S0ZahI&key=${API_KEY}`;
...
export const RELATED_VIDEOS_API_2 = `&key=${API_KEY}`;
...
export const CHANNEL_API = `https://youtube.googleapis.com/youtube/v3/channels?part=snippet&key=${API_KEY}&id=`;

export const CHANNEL_DETAILS_API = `https://youtube.googleapis.com/youtube/v3/channels?part=snippet%2Cstatistics&key=${API_KEY}&id=`;
